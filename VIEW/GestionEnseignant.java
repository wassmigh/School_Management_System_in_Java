...
public class GestionEnseignant extends JFrame {
	...
	public GestionEnseignant() {
		setTitle("Gérer les enseignants");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String mdp = mdptext.getText();
					Enseignant es = new Enseignant(nom,prenom,date,adr,email,tel,username,mdp);
					enseignants.add(es);
					Vector v = new Vector();
					 v.add(es.getId());
					 v.add(es.getNom());
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String mdp = mdptext.getText();
				if(id !=0) {
					Enseignant es = new Enseignant(id,nom,prenom,date,adr,email,tel,username,mdp);
					Enseignant_dao.modifyEnseignant(es);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Enseignant_dao.deleteEnseignant(id);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int rowstart = lastRowIndex - enseignants.size() +1;
				for(Enseignant es :enseignants ) {
					Utilisateur u = new Utilisateur(es.getNomUtilisateur(),es.getMotDePasse(),"Enseignant");
					int ide = User_dao.addUtilisateur(u);
					es.setId(ide);
					Enseignant_dao.addEnseignant(es);
		...
		datetext.setBounds(166, 125, 139, 20);
		...
		emailtext.setBounds(327, 80, 123, 20);
		contentPane.add(emailtext);
		emailtext.setColumns(10);
		
		teltext = new JTextField();
		teltext.setBounds(498, 125, 123, 20);
		...
		lblNewLabel_1.setBounds(19, 83, 64, 14);
		...
		lblNewLabel_5.setBounds(332, 128, 175, 14);
